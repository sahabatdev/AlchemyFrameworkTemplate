...
<recipe>
    ...
    <dependency mavenUrl="com.squareup.picasso:picasso:+" />
    <dependency mavenUrl="com.nineoldandroids:library:+" />
    <dependency mavenUrl="com.daimajia.slider:library:1.1.5@aar:+" />
